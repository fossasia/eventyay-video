...
export default {
	...
	methods: {
		...
		getYoutubeUrl(ytid, autoplay, mute) {
			...
			return `https://www.youtube-nocookie.com/embed/${ytid}?${autoplayParam}?enablejsapi=1&autoplay=1&modestbranding=1&loop=1&controls=0&disablekb=1&rel=0&showinfo=0&playlist=${ytid}&${muteParam}`;
		},
